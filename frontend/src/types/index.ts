/**
 * Core Type Definitions for TokenPanel Frontend
 */
...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'lingjing' | 'generic' | 'grok' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'lingjing' | 'generic' | 'grok'
