export default {
  ...
  admin: {
    ...
    settings: {
      ...
      sms: {
        title: '火山引擎短信（SMS）',
        description: '配置手机号注册和登录所需的短信服务',
        phoneRegisterEnabled: '启用手机号注册',
        phoneRegisterEnabledHint: '开启后将关闭邮件验证，用户通过手机号+短信验证码注册和登录',
        accessKeyID: 'Access Key ID',
        accessKeyIDPlaceholder: 'AK...',
        accessKeySecret: 'Access Key Secret',
        accessKeySecretPlaceholder: '输入新的 Secret',
        accessKeySecretConfiguredPlaceholder: '已配置，留空以保留当前值',
        accessKeySecretHint: '首次配置请输入 Access Key Secret',
        accessKeySecretConfiguredHint: 'Secret 已配置，留空则保留当前值',
