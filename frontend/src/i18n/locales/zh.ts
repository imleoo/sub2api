export default {
  ...
  admin: {
    ...
    promptAnalytics: {
      ...
      globalView: '全局视图',
      userView: '用户视图',
      noData: '暂无关键词数据。关键词从用户提示词中采样提取。',
      refresh: '刷新',
      limit: '显示前',
      userId: '用户 ID',
      userIdPlaceholder: '按用户 ID 过滤（留空查看全局）',
      rank: '排名',
      keyword: '关键词',
      count: '次数',
      currentPeriod: '当前周期',
    ...
    ops: {
      ...
      settings: {
        ...
        ignoreNoAvailableAccountsHint: '启用后，"No available accounts" 错误将不会写入错误日志。',
      },
    },
  },
  models: {
