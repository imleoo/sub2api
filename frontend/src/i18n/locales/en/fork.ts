...
export default {
  ...
  team: {
    ...
    members: {
      ...
      inviteHint: "Registered users will see the invitation on their Team page and can accept it directly; unregistered emails can accept via the email link after signing up",
      receivedTitle: "Invitations for me",
      receivedFrom: "Team invitation from {email}",
      receivedAccept: "Accept",
      receivedAcceptSuccess: "Joined the team",
