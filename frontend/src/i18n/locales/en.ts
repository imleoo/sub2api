export default {
  ...
  admin: {
    ...
    dashboard: {
      ...
      modelDistribution: 'Model Distribution',
      groupDistribution: 'Group Usage Distribution',
      // Phase 1 P1-4: Provider / Account cross-group aggregation views
    ...
    accounts: {
      ...
      generic: {
        ...
        syncModelsLoading: 'Syncing…',
        syncModelsApiKey: 'API Key for sync',
        syncModelsApiKeyPlaceholder: 'Used only to fetch the model list; not saved with the account',
        syncModelsHint: 'Calls /v1/models using the Base URL above + this API key. Fetched models are written to the pricing table where you can set discounts under "Model Pricing".',
        syncModelsSuccess: 'Fetched {count} models and saved them to the pricing table',
        syncModelsFailed: 'Failed to sync models',
        syncModelsNeedBaseUrl: 'Please fill in the Base URL first',
        syncModelsNeedApiKey: 'Please fill in the API key for sync first',
      },
      types: {
        oauth: 'OAuth',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another tokenpanel instance.',
