...
const formatAccountCost = computed(() => {
  if (!props.windowStats) return formatUSD(0)
  return formatUSD(props.windowStats.cost)
})

const formatUserCost = computed(() => {
  if (!props.windowStats || props.windowStats.user_cost == null) return formatUSD(0)
  return formatUSD(props.windowStats.user_cost)
})
