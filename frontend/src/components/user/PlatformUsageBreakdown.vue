<template>
  <div class="group/usage relative text-sm">
    ...
    <div
      v-if="hasBreakdown"
      :class="[
        'pointer-events-none absolute top-0 z-50 min-w-[220px] whitespace-nowrap rounded-md bg-gray-900 px-3 py-2 text-xs text-white opacity-0 shadow-xl transition-opacity duration-100 group-hover/usage:opacity-100 dark:bg-dark-600',
