<template>
  <BaseDialog
    :show="show"
    :title="t('admin.users.usageStatistics')"
    width="extra-wide"
    @close="handleClose"
  >
    <div class="space-y-6">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-indigo-100 p-1.5 dark:bg-indigo-900/30">
                <Icon name="trendingUp" size="sm" class="text-indigo-600 dark:text-indigo-400" />
              </div>
              <span class="text-sm font-semibold text-gray-900 dark:text-white">{{
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-lime-100 p-1.5 dark:bg-lime-900/30">
                <Icon name="clipboard" size="sm" class="text-lime-600 dark:text-lime-400" />
              </div>
              <span class="text-sm font-semibold text-gray-900 dark:text-white">{{
...
const trendChartData = computed(() => {
  ...
  return {
    ...
    datasets: [
      {
        label: `${t('usage.userBilled')} (${currencyLabel()})`,
...
const lineChartOptions = computed(() => ({
  ...
  scales: {
    ...
    y: {
      ...
      title: {
        display: true,
        text: `${t('usage.userBilled')} (${currencyLabel()})`,
        color: '#10b981',
        font: { size: 11 }
      }
    },
