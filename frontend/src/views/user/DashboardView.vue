  ...
  <AppLayout>
    <div class="space-y-6">
      ...
      <template v-else-if="stats">
        <UserDashboardStats :stats="stats" :balance="displayBalance" :is-simple="authStore.isSimpleMode" :platform-quotas="platformQuotas" />
...
const displayBalance = computed(() => Number(user.value?.balance ?? 0))
