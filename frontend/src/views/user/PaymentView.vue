        ...
        <template v-else>
          ...
          <template v-if="activeTab === 'recharge'">
            ...
            <div class="card p-5">
              ...
              <p class="mt-0.5 text-sm font-medium text-green-600 dark:text-green-400">{{ t('payment.currentBalance') }}: {{ appStore.currencyMode === 'cny' ? `¥${((user?.balance || 0) * appStore.cnyRate).toFixed(2)}` : `$${user?.balance?.toFixed(2) || '0.00'}` }}</p>
            </div>
