        ...
        <table class="w-full border-separate border-spacing-0">
          ...
          <tbody class="divide-y divide-gray-100 dark:divide-dark-700">
            ...
            >
              ...
              <!-- Client IP -->
              <td class="whitespace-nowrap px-4 py-2">
                <span v-if="log.client_ip" class="font-mono text-[11px] text-gray-600 dark:text-gray-400">
                  {{ log.client_ip }}
                </span>
                <span v-else class="text-xs text-gray-400">-</span>
              </td>
              ...
              <!-- API Key -->
              <td class="px-4 py-2">
                <el-tooltip v-if="log.api_key_id" :content="t('admin.ops.errorLog.id') + ' ' + log.api_key_id" placement="top" :show-after="500">
                  <span class="max-w-[100px] truncate font-mono text-[11px] text-gray-600 dark:text-gray-400">
                    {{ log.api_key_name || String(log.api_key_id) }}
                  </span>
                </el-tooltip>
                <span v-else class="text-xs text-gray-400">-</span>
              </td>
