  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        glow: '0 0 20px rgb(var(--color-primary-glow) / 0.25)',
        'glow-lg': '0 0 40px rgb(var(--color-primary-glow) / 0.35)',
      ...
      keyframes: {
        ...
        glow: {
          '0%': { boxShadow: '0 0 20px rgb(var(--color-primary-glow) / 0.25)' },
          '100%': { boxShadow: '0 0 30px rgb(var(--color-primary-glow) / 0.4)' }
        }
      },
      backdropBlur: {
        xs: '2px'
