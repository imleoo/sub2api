...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "outbound_protocol", Type: field.TypeString, Nullable: true, Size: 30, Default: ""},
	...
	EndpointsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "stable_id", Type: field.TypeString, Size: 128},
		{Name: "outbound_protocol", Type: field.TypeString, Size: 50},
		{Name: "base_url", Type: field.TypeString, Size: 512},
		{Name: "auth_header", Type: field.TypeString, Size: 64, Default: "Authorization"},
		{Name: "auth_scheme", Type: field.TypeString, Size: 32, Default: "Bearer"},
		{Name: "models_source", Type: field.TypeString, Size: 20, Default: "remote"},
	...
	EndpointsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{EndpointsColumns[2], EndpointsColumns[8]},
			},
		},
	}
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "upstream_unit_price_input", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "upstream_unit_price_output", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "upstream_unit_price_cache_creation", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "upstream_unit_price_cache_read", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "upstream_total_cost", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "provider", Type: field.TypeString, Nullable: true, Size: 50},
		{Name: "pricing_source", Type: field.TypeString, Nullable: true, Size: 20},
		{Name: "async_task_id", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "cost_finalized_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		...
		{Name: "video_seconds", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(10,3)"}},
		...
		{Name: "endpoint_id", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "endpoint_protocol", Type: field.TypeString, Nullable: true, Size: 50},
		{Name: "bill_request_id", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "api_key_id", Type: field.TypeInt64},
		{Name: "account_id", Type: field.TypeInt64},
		{Name: "group_id", Type: field.TypeInt64, Nullable: true},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[57], UsageLogsColumns[53]},
			},
			{
				Name:    "usagelog_api_key_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[54], UsageLogsColumns[53]},
			},
			{
				Name:    "usagelog_group_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[56], UsageLogsColumns[53]},
			},
		},
	}
...
func init() {
	...
	EndpointsTable.ForeignKeys[0].RefTable = AccountsTable
