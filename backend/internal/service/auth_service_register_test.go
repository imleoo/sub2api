...
func (s *emailCacheStub) IncrVerifyAttempts(context.Context, string, time.Duration) (int64, error) {
	return 1, nil
}
...
func TestAuthService_Register_EmailVerifyEnabledButServiceNotConfigured(t *testing.T) {
	...
	_, _, err := service.RegisterWithVerification(context.Background(), "user@test.com", "password", "testuser", "any-code", "", "", "")
...
func TestAuthService_Register_EmailVerifyRequired(t *testing.T) {
	...
	_, _, err := service.RegisterWithVerification(context.Background(), "user@test.com", "password", "testuser", "", "", "", "")
...
func TestAuthService_Register_EmailVerifyInvalid(t *testing.T) {
	...
	_, _, err := service.RegisterWithVerification(context.Background(), "user@test.com", "password", "testuser", "wrong", "", "", "")
