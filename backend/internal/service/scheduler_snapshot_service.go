...
func schedulerSnapshotPlatforms() [4]string {
	return [4]string{PlatformAnthropic, PlatformGemini, PlatformOpenAI, PlatformLingjing}
}
...
func (s *SchedulerSnapshotService) defaultBuckets(ctx context.Context) ([]SchedulerBucket, error) {
	...
	platforms := []string{PlatformAnthropic, PlatformGemini, PlatformOpenAI, PlatformLingjing}
