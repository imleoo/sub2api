...
// grokBillingSnapshot 是 CLI 计费探测（Grok OAuth 逆向订阅，功能 35）遗留的最小字段集合，
// 仅供下方已被 IsGrokOAuth()==false 提前短路的死代码分支保持类型检查通过之用。
...
func grokBillingSnapshotFromExtra(_ map[string]any) (*grokBillingSnapshot, error) {
	return nil, nil
}
