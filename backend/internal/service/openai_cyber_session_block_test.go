...
func (c *comboCacheAndStore) GetSessionEndpointStableID(_ context.Context, _ int64, _ string) (string, error) {
	return "", nil
}

func (c *comboCacheAndStore) SetSessionEndpointStableID(_ context.Context, _ int64, _ string, _ string, _ time.Duration) error {
	return nil
}

func (c *comboCacheAndStore) DeleteSessionEndpointStableID(_ context.Context, _ int64, _ string) error {
	return nil
}
