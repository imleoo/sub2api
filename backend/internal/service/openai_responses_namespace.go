...
func shouldFlattenOpenAIResponsesNamespaces(_ *Account, _ OpenAIUpstreamTransport, _ bool) bool {
	// fork：Codex OAuth 账号类型已随订阅逆向清理移除（功能 35），命名空间摊平
	// 原本仅对 OAuth 账号生效，apikey 账号恒不摊平，行为与上游一致。
	return false
}
