...
func (c *outboxCleanupCache) IncrDualBucketTotal(context.Context, string) (int64, error) {
	return 0, nil
}

func (c *outboxCleanupCache) IncrDualBucketDiverged(context.Context, string) (int64, error) {
	return 0, nil
}

func (c *outboxCleanupCache) GetDualBucketStats(context.Context, string, int) ([]DualBucketDayStats, error) {
	return nil, nil
}
