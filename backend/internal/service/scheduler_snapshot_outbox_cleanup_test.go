...
func (c *outboxCleanupCache) GetDualBucketStats(_ context.Context, _ string, _ int) ([]DualBucketDayStats, error) {
	return nil, nil
}

func (c *outboxCleanupCache) IncrDualBucketTotal(_ context.Context, _ string) (int64, error) {
	return 0, nil
}

func (c *outboxCleanupCache) IncrDualBucketDiverged(_ context.Context, _ string) (int64, error) {
	return 0, nil
}
