...
func TestAdminAuthJWTValidatesTokenVersion(t *testing.T) {
	...
	authService := service.NewAuthService(nil, nil, nil, nil, cfg, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	...
	t.Run("websocket_token_version_mismatch_rejected", func(t *testing.T) {
		...
		req.Header.Set("Sec-WebSocket-Protocol", "tokenpanel-admin, jwt."+token)
		router.ServeHTTP(w, req)
...
func (s *stubUserRepo) GetByPhone(context.Context, string) (*service.User, error) {
	return nil, service.ErrUserNotFound
}
