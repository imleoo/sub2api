...
func load(allowMissingJWTSecret bool) (*Config, error) {
	...
	viper.AddConfigPath("/etc/tokenpanel")
...
func setDefaults() {
	...
	viper.SetDefault("log.service_name", "tokenpanel")
	...
	viper.SetDefault("database.dbname", "tokenpanel")
	...
	viper.SetDefault("dashboard_cache.key_prefix", "tokenpanel:")
	...
	viper.SetDefault("gateway.scheduling.dual_bucket_enabled", false)
	viper.SetDefault("gateway.scheduling.protocol_bucket_enabled", false)
...
func GetServerAddress() string {
	...
	v.AddConfigPath("/etc/tokenpanel")
