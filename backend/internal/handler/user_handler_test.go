...
func (s *userHandlerRepoStub) ExistsByPhone(context.Context, string) (bool, error) {
	return false, nil
}
...
func (s *userHandlerEmailCacheStub) IncrVerifyAttempts(context.Context, string, time.Duration) (int64, error) {
	return 1, nil
}
