...
var upgrader = websocket.Upgrader{
	...
	// - The frontend passes ["tokenpanel-admin", "jwt.<token>"].
	// - We always select "tokenpanel-admin" so the token is never echoed back in the handshake response.
	Subprotocols: []string{"tokenpanel-admin"},
}
