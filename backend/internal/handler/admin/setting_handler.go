...
func NewSettingHandler(settingService *service.SettingService, emailService *service.EmailService, turnstileService *service.TurnstileService, opsService *service.OpsService, paymentConfigService *service.PaymentConfigService, paymentService *service.PaymentService, pricingService *service.PricingService, adminService service.AdminService, userAttributeService *service.UserAttributeService) *SettingHandler {
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		ShowOverseasModels: func() bool {
			if req.ShowOverseasModels != nil {
				return *req.ShowOverseasModels
			}
			return previousSettings.ShowOverseasModels
		}(),
...
// 兜底 upsert 对应 user attribute definition。失败仅记录日志，不阻塞保存。
